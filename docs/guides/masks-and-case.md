...
Here's what a plain [`text`](../generators/text.md#top) generator emits for a batch of
...
documented in [Strings & formatting](../compute/strings.md#top).
...
[`TDC199`](../reference/errors.md#top) instead, reported before a single row is
generated:
...
**Tool.** Put `mask="…"` or `case="…"` right on the [`<gen>`](../generators/overview.md#top).
...
**Problem.** By default, [`text`](../generators/text.md#top) and
[`file`](../generators/file.md#top) pick values **at random**. Sometimes the data has an
...
deliberately ignored rather than [refused](../reference/errors.md#top).
...
- **[Strings & formatting](../compute/strings.md#top)** — the same operations as compute tags.
- **[Output & formatting](../core-concepts/output-formatting.md#top)** — where interpolation and filters live.
- **[Output formats](../guides/output-formats.md#top)** — CSV, JSON, and SQL end-to-end.
