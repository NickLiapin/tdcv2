...
**English** · [Русский](../ru/guides/signals-from-formulas.md#top) · [Español](../es/guides/signals-from-formulas.md#top)

📖 **[Read this on the documentation site →](https://nickliapin.github.io/tdcv2/docs/guides/signals-from-formulas)**

← Previous: [Performance](./performance.md#top) · **[Contents](../README.md#top)** · Next: [Overview](../data-packs/overview.md#top) →
...
[`<gen type="formula">`](../generators/formula.md#top), and it is the one construct that can
...
`exp` and `pow` are ordinary [expression functions](../reference/expressions.md#top), and they
...
![Five faint bell curves and the darker line of their sum, over one beat](../img/guides/ecg-anatomy.svg)
...
![Five seconds of trace on grid paper, with dashed verticals at whole seconds](../img/guides/ecg-strip.svg)
...
[`running`](../generators/running.md#top). For one figure computed over the whole run, see
[`stat`](../generators/stat.md#top).
