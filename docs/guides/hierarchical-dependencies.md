...
> [formatting layer](../guides/masks-and-case.md#top) runs, so it compares against the value
...
> that blanks some of its rows with [`missing=`](../guides/anomalies.md#top) still counts
