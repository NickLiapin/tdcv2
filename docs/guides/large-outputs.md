...
repeats a given config actually produces is not something to estimate from the birthday
formula: measured on a 6,000,000-row run, the fingerprint scan handed the verifier 99,852
candidate groups where that formula predicts about 11,000. Run it and watch `--progress`.
