...
**Use it when** you need a technical identifier that has to *look* real and **pass a
...
> examples of *shape*, not as guarantees.
...
| Path                                 | Produces                                                                          | Example             |
| :----------------------------------- | :-------------------------------------------------------------------------------- | :------------------ |
| `common.docs.mrz.id_td1`             | ICAO 9303 TD1 identity-card MRZ (three 30-char lines) with composite check digits | *(see above)*       |
| `common.docs.mrz.passport_td3`       | ICAO 9303 TD3 passport MRZ (two 44-char lines) with composite check digits        | *(see above)*       |
