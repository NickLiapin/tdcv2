...
```
20 000 x 20 000 значений → около 28 800 повторов, больше предохранителя → не прошёл и в 512 МБ
40 000 x 40 000 значений → около  7 200 повторов, меньше него           → уложился в 256 МБ
```
