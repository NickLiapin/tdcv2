...
каталог. 292 наборов на экран не помещаются, поэтому их листают так, как они устроены:
...
В каталоге сегодня **292 наборов**: `common`, 93 языков и 198 стран. Языка или страны,
