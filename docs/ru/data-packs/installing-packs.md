...
каталог. 293 наборов на экран не помещаются, поэтому их листают так, как они устроены:
...
В каталоге сегодня **293 наборов**: `common`, 94 языков и 198 стран. Языка или страны,
