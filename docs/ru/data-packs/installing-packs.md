...
каталог. 287 наборов на экран не помещаются, поэтому их листают так, как они устроены:
...
В каталоге сегодня **287 наборов**: `common`, 88 языков и 198 стран. Языка или страны,
