...
> | Java     | скачать `tdcv2-0.1.4-cli.jar` с Maven Central     | `java -jar tdcv2-0.1.4-cli.jar pack add ru` |
>
...
> ```
>
> Стоит завести алиас — `alias tdcv2='java -jar /путь/к/tdcv2-0.1.4-cli.jar'` — после этого
