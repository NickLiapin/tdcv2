...
каталог. 285 наборов на экран не помещаются, поэтому их листают так, как они устроены:
...
В каталоге сегодня **285 наборов**: `common`, 86 языков и 198 стран. Языка или страны,
