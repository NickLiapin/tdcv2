...
каталог. 239 наборов на экран не помещаются, поэтому их листают так, как они устроены:
...
В каталоге сегодня **239 наборов**: `common`, 86 языков и 152 стран. Языка или страны,
