...
каталог. 243 наборов на экран не помещаются, поэтому их листают так, как они устроены:
...
В каталоге сегодня **243 наборов**: `common`, 86 языков и 156 стран. Языка или страны,
