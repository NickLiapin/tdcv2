...
каталог. 286 наборов на экран не помещаются, поэтому их листают так, как они устроены:
...
В каталоге сегодня **286 наборов**: `common`, 87 языков и 198 стран. Языка или страны,
