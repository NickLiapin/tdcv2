...
Шаг делается **один раз** и никогда не доходит до английского. `zh-tw` ищет `zh`, не
находит ничего и отказывает — потому что выдать прогону на традиционном китайском
упрощённые данные из `zh-cn` было бы хуже, чем сказать об этом прямо.
