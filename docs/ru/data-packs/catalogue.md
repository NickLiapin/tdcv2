...
| Pack | Name | Holds |
| :--- | :--- | :--- |
| `albania` | Albania **(след. релиз)** | docs, education, finance, geo, government, holiday, phone, sport, tax, telecom, vehicle |
...
| `armenia` | Armenia **(след. релиз)** | docs, education, finance, geo, government, holiday, language, phone, phoneLandline, product, sport, tax, telecom, vehicle |
...
| `azerbaijan` | Azerbaijan **(след. релиз)** | docs, education, finance, geo, government, holiday, phone, phoneLandline, phoneMobilePrefix, phoneNational, sport, tax, vehicle |
| `bahrain` | Bahrain | docs, education, finance, geo, holiday, phone, sport, vehicle |
| `bangladesh` | Bangladesh **(след. релиз)** | docs, education, finance, geo, holiday, phone, sport, tax, vehicle |
...
| `bhutan` | Bhutan **(след. релиз)** | docs, education, finance, geo, government, holiday, phone, phoneAreaCode, phoneLandline, phoneMobilePrefix, phoneNational, society, sport, tax, telecom, vehicle |
| `bolivia` | Bolivia | docs, education, finance, geo, holiday, phone, sport, tax, vehicle |
| `bosnia_and_herzegovina` | Bosnia And Herzegovina **(след. релиз)** | docs, education, finance, geo, government, holiday, language, phone, phoneLandline, sport, tax, vehicle |
...
| `cambodia` | Cambodia **(след. релиз)** | docs, education, finance, geo, government, holiday, legal, phone, phoneAreaCode, phoneLandline, phoneMobilePrefix, phoneMobilePrefixWithLength, sport, tax, vehicle |
...
| `georgia` | Georgia **(след. релиз)** | docs, education, finance, geo, government, holiday, legal, phone, phoneAreaCode, phoneLandline, phoneMobilePrefix, sport, tax, vehicle |
| `germany` | Germany | docs, education, finance, geo, holiday, phone, sport, tax, vehicle |
| `ghana` | Ghana **(след. релиз)** | docs, education, finance, geo, holiday, language, phone, phoneNational, phonePrefix, sport, tax, vehicle |
...
| `iceland` | Iceland **(след. релиз)** | docs, education, finance, geo, government, holiday, phone, phoneLandline, sport, tax, telecom, vehicle |
| `india` | India **(след. релиз)** | docs, education, finance, geo, holiday, language, phone, sport, tax, vehicle |
| `indonesia` | Indonesia **(след. релиз)** | docs, education, finance, geo, holiday, phone, sport, tax, vehicle |
| `iran` | Iran **(след. релиз)** | docs, education, finance, geo, holiday, phone, phoneLandline, sport, tax, vehicle |
...
| `israel` | Israel **(след. релиз)** | docs, education, finance, geo, holiday, phone, phoneLandline, sport, tax, vehicle |
...
| `japan` | Japan **(след. релиз)** | docs, education, finance, geo, holiday, phone, phoneLandline, sport, tax, vehicle |
...
| `kenya` | Kenya **(след. релиз)** | docs, education, finance, geo, holiday, phone, phoneLandline, sport, tax, vehicle |
...
| `laos` | Laos **(след. релиз)** | docs, education, finance, geo, government, holiday, legal, phone, phoneAreaCode, phoneLandline, phoneMobilePrefix, sport, tax, vehicle |
...
| `malaysia` | Malaysia **(след. релиз)** | docs, education, finance, geo, government, holiday, phone, sport, tax, vehicle |
| `maldives` | Maldives **(след. релиз)** | calendar, docs, education, finance, geo, government, holiday, holidayDate, holidayEnglish, phone, phoneLandline, phoneMobilePrefix, phoneNational, sport, tax, vehicle |
...
| `moldova` | Moldova **(след. релиз)** | docs, education, finance, food, geo, holiday, language, phone, sport, tax, vehicle |
| `monaco` | Monaco | education, finance, geo, holiday, phone, sport, vehicle |
| `mongolia` | Mongolia **(след. релиз)** | docs, education, finance, geo, government, holiday, legal, phone, phoneAreaCode, phoneLandline, phoneMobilePrefix, sport, tax, telecom, vehicle |
...
| `myanmar` | Myanmar **(след. релиз)** | docs, education, finance, geo, government, holiday, legal, phone, phoneLandline, phoneMobilePrefix, sport, tax, vehicle |
| `nepal` | Nepal **(след. релиз)** | calendar, docs, education, finance, geo, holiday, phone, phoneAreaCode, phoneLandline, sport, symbol, symbolEnglish, tax, vehicle |
...
| `nigeria` | Nigeria **(след. релиз)** | docs, education, finance, geo, holiday, language, phone, phoneNational, phonePrefix, sport, tax, vehicle |
| `north_macedonia` | North Macedonia **(след. релиз)** | docs, education, finance, geo, government, holiday, language, phone, phoneAreaCode, sport, tax, vehicle |
| `norway` | Norway **(след. релиз)** | docs, education, finance, geo, government, holiday, phone, phoneLandline, phoneMobilePrefix, phoneNational, sport, tax, vehicle |
| `oman` | Oman | docs, education, finance, geo, holiday, phone, sport, vehicle |
| `pakistan` | Pakistan **(след. релиз)** | docs, education, finance, geo, holiday, language, phone, sport, tax, vehicle |
...
| `philippines` | Philippines **(след. релиз)** | docs, education, finance, geo, holiday, person, phone, sport, tax, vehicle |
...
| `serbia` | Serbia **(след. релиз)** | docs, education, finance, geo, holiday, phone, sport, tax, vehicle |
| `singapore` | Singapore **(след. релиз)** | docs, education, finance, geo, holiday, phone, phoneLandline, sport, tax, vehicle |
...
| `south_korea` | South Korea **(след. релиз)** | docs, education, finance, geo, holiday, phone, phoneAreaCode, phoneLandline, sport, tax, vehicle |
...
| `sri_lanka` | Sri Lanka **(след. релиз)** | docs, education, finance, geo, holiday, language, phone, phoneLandline, sport, tax, vehicle |
...
| `taiwan` | Taiwan **(след. релиз)** | calendar, docs, education, finance, geo, government, holiday, legal, phone, phoneAreaCode, phoneLandline, phoneMobilePrefix, sport, tax, telecom, vehicle |
| `tajikistan` | Tajikistan | docs, education, finance, geo, holiday, phone, sport, vehicle |
| `tanzania` | Tanzania **(след. релиз)** | docs, education, finance, geo, holiday, holidayEnglish, phone, phoneLandline, sport, tax, vehicle |
| `thailand` | Thailand **(след. релиз)** | calendar, docs, education, finance, geo, holiday, phone, phoneLandline, sport, tax, vehicle |
...
| `turkey` | Turkey **(след. релиз)** | docs, education, finance, geo, holiday, phone, sport, tax, vehicle |
| `turkmenistan` | Turkmenistan **(след. релиз)** | docs, education, finance, geo, government, holiday, phone, phoneAreaCode, phoneLandline, phoneMobilePrefix, phoneNational, sport, tax, vehicle |
| `uae` | Uae | docs, education, finance, geo, holiday, phone, sport, vehicle |
| `uganda` | Uganda **(след. релиз)** | culture, docs, education, finance, geo, holiday, phone, phoneLandline, sport, tax, vehicle |
| `ukraine` | Ukraine **(след. релиз)** | docs, education, finance, geo, holiday, phone, sport, tax, vehicle |
...
| `uzbekistan` | Uzbekistan **(след. релиз)** | docs, education, finance, geo, government, holiday, phone, phoneAreaCode, phoneAreaCodeWithRegion, phoneLandline, phoneMobilePrefix, phoneNational, sport, tax, telecom, vehicle |
...
| `vietnam` | Vietnam **(след. релиз)** | docs, education, finance, geo, holiday, phone, sport, tax, vehicle |
| `yemen` | Yemen | docs, education, finance, geo, holiday, phone, sport |
| `zimbabwe` | Zimbabwe **(след. релиз)** | docs, education, finance, geo, holiday, language, phone, sport, tax, vehicle |

Install any of them with `tdcv2 pack add <pack>`.

> Этот пакет новее опубликованных версий. Он скачивается, но его адреса не разрешатся до следующего релиза — и пока он лежит в хранилище, посторонние конфиги выдают предупреждения TDC171. Проверено на опубликованной 0.2.2.
