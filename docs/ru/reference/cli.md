...
`uniq`-прогоне самой длинной обычно оказывается `uniq-repair` — на 6 000 000 строк по
900 000 000 возможных пар это 50–62 секунды из 88–99, больше остальных трёх вместе взятых, —
так что ждать стоит именно там.
