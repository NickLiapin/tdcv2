...
смысл. Но часы становятся четвёртым входом прогона — рядом с конфигом, сидом и движком, —
и единственным, который нельзя записать. Тот же файл с тем же сидом завтра выдаст другие
строки.
