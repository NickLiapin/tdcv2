...
**Остальная математическая библиотека.** `digamma`, `beta`, `zeta`, `degrees` и `radians`
отвергаются по имени, а не угадываются:
...
Обратите внимание, чего сообщение НЕ говорит: «может, вы имели в виду `gamma`?» Расстояние
