...
**Остальная математическая библиотека.** `erf`, `erfc`, `gamma`, `lgamma`, `degrees` и
`radians` отвергаются по имени, а не угадываются:
...
Обратите внимание, чего сообщение НЕ говорит: «может, вы имели в виду `exp`?» Расстояние
