...
| :----------------------------------------- | :----------- | :------------------------------------------------------------------------ |
| [`src`](../reference/attributes.md#top)       | да           | Где файл — относительный путь, `@data` или абсолютный путь                |
...
в том порядке, в каком они идут в файле (см. [`order=` / `cycle=`](overview.md#top)).
