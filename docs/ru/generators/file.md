...
Большого атома это не касается: 40% ровно нулей возвращаются как 39.995%, потому
что его полка много шире скатов по краям. Значение, встретившееся дважды на
тысячу, сохраняет примерно половину своей доли.

Итого: если важна точная доля каждого перечисленного значения — это
