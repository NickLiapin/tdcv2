...
Любая другая локаль получает [TDC217](../reference/errors.md#top) — он называет локали, где
...
>
> `location.country` есть во всех одиннадцати языковых пакетах реестра — **ar**, **de**, **el**,
> **en**, **es**, **fr**, **it**, **pl**, **pt**, **ru** и **zh-cn**, — и везде это одни и те же 233
...
Ответ у движка уже есть. Фильтр [`csv`](../core-concepts/output-formatting.md#top) берёт
...
же 233 в каждой локали, кроме английской, где их 237. `geo.*` — голос **странового** пакета: места внутри одной страны и список
...
[Пакетах данных](../data-packs/overview.md#top).
...
>
> `person.b_day` и [`<gen type="date" value="birth">`](date.md#день-рождения-через-valuebirth)
