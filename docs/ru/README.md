...
- [Структура конфигурации](./core-concepts/configuration.md#top)
...
- [Шаблон](./generators/template.md#top)
- [Файл](./generators/file.md#top)
- [Дата](./generators/date.md#top)
- [symbol](./generators/symbol.md#top)
- [Regex](./generators/regex.md#top)
- [Продвинутый Regex](./generators/advanced-regex.md#top)
- [Счётчики (increment / decrement)](./generators/counters.md#top)
- [Временные ряды](./generators/timeseries.md#top)
...
- [Обзор](./pools/overview.md#top)
- [Отбор через filter](./pools/filter.md#top)
- [Связывание пулов](./pools/linking.md#top)

## Конструкции

- [Обзор](./constructs/overview.md#top)
- [Выбор между значениями (mix)](./constructs/mix.md#top)
- [Таблицы соответствий (switch)](./constructs/switch.md#top)
- [Условный вывод (if)](./constructs/conditional-output.md#top)
...
- [Обзор](./compute/overview.md#top)
- [Арифметика](./compute/arithmetic.md#top)
- [Списки и перебор](./compute/lists.md#top)
- [Строки и форматирование](./compute/strings.md#top)
- [Условия](./compute/conditionals.md#top)
- [Разбор пака построчно](./compute/walkthrough.md#top)

## Руководства

- [Иерархические зависимости](./guides/hierarchical-dependencies.md#top)
- [Связные данные](./guides/coherent-data.md#top)
- [Без повторов в строке (distinct)](./guides/distinct.md#top)
- [Файлы и CSV](./guides/files-and-csv.md#top)
- [Форматы вывода (CSV, JSON, SQL…)](./guides/output-formats.md#top)
- [Маски и регистр](./guides/masks-and-case.md#top)
- [Статистические распределения](./guides/statistical-distributions.md#top)
- [Аномалии и выбросы](./guides/anomalies.md#top)
- [Пропуски в данных](./guides/missing-data.md#top)
...
- [Теги](./reference/tags.md#top)
- [Атрибуты](./reference/attributes.md#top)
- [Генераторы](./reference/generators.md#top)
- [Compute-функции](./reference/compute.md#top)
...
- [Одни и те же имена везде](./bindings/same-names.md#top)
