...
> длин, а какой именно — решает [сид](../core-concepts/determinism.md#top), так что 201 строка
...
> [`<gen type="pattern" mode="density">`](../generators/pattern.md#top), воспроизводит *форму* с
...
Взвешенный [пакет данных](../data-packs/overview.md#top) при этом работает и
...
([`TDC291`](../reference/errors.md#top)), а не выполняет молча одно и роняет
другое. Если нужны доли по **длинам** списков — ставьте их на
[`<mix>`](./mix.md#top) или `<switch>` снаружи, а `repeat` на
генератор внутри.
