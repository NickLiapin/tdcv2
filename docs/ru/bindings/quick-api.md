...
[English](../../bindings/quick-api.md#top) · **Русский** · [Español](../../es/bindings/quick-api.md#top)

📖 **[Открыть на сайте документации →](https://nickliapin.github.io/tdcv2/ru/docs/bindings/quick-api)**

← Назад: [TypeScript](./typescript.md#top) · **[Оглавление](../README.md#top)** · Вперёд: [Python](./python.md#top) →
...
- **[TypeScript](./typescript.md#top)** — класс `TDC`, для целых наборов данных.
