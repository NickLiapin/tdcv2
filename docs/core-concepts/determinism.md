...
and the same output mode. Any of those four changing is licence for the bytes to change;
the language you run it from is not, which is why five implementations agree. This page
covers
