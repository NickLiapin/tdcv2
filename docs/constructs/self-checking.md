...
| :-------- | :--------- | :---------------------------------------------------------------------------------- |
| `that`    | one of two | A condition over whole-run values, read once, in the [`if=`](../reference/expressions.md#top) language |
...
[built-ins](../reference/builtins.md#top). Nothing new to learn, and no `stat` column to
build first.
