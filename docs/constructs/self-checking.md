...
**English** · [Русский](../ru/constructs/self-checking.md#top) · [Español](../es/constructs/self-checking.md#top)

📖 **[Read this on the documentation site →](https://nickliapin.github.io/tdcv2/docs/constructs/self-checking)**

← Previous: [Uniqueness (uniq, distinct)](./unique-values.md#top) · **[Contents](../README.md#top)** · Next: [Overview](../compute/overview.md#top) →
...
It lives in `<env>`, beside [`<uniq>` and `<distinct>`](unique-values.md#top), because like
...
| :-------- | :------- | :-------------------------------------------------------------- |
| `that`    | yes      | The condition, in the same language as [`if=`](../reference/expressions.md#top) |
...
[`<gen type="stat">`](../generators/stat.md#top) — one number for the whole run.
...
- **Asserting a check digit.** That is the trap — [`<compute>`](../compute/overview.md#top)
...
- [`stat`](../generators/stat.md#top) — where the numbers come from
- [Expressions](../reference/expressions.md#top) — the language `that=` is written in
- [Uniqueness](unique-values.md#top) — the other whole-run statements
