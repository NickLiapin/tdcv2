...
Think of it as a [`<sequence>`](../core-concepts/sequences.md#top) whose values are
...
a given [`seed`](../core-concepts/determinism.md#top).
...
`<mix>` sits **directly in [`<env>`](../core-concepts/configuration.md#top)**, right
...
[`percent`](../generators/text.md#top) on the `text` generator.
...
[`text`](../generators/text.md#top) generator already does exact shares with
`percent`.
...
[`percent` on `text`](../generators/text.md#top): a number fixes that branch's share,
...
[`<sequence>`](../core-concepts/sequences.md#top). Here the paid accounts get a tier
...
assemble its value from several pieces — a literal [`<data>`](../core-concepts/output-formatting.md#top)
fragment, one or more [generators](../generators/overview.md#top), and a nested
...
[`number`](../generators/number.md#top) in `1..10`; `66 (flagged)` is a number in
...
[output block](../core-concepts/output-formatting.md#top) is for layout only. Declare
...
- A [`<sequence>`](../core-concepts/sequences.md#top) with conditional
  [`<gen if="…">`](../core-concepts/sequences.md#top) branches picks by an **arbitrary
...
- **[Text generator](../generators/text.md#top)** — exact `percent` shares for a plain
  list of options, when the branches are single words.
- **[Sequences](../core-concepts/sequences.md#top)** — the named source `<mix>` sits
  next to, and the `parent` model the two share.
- **[Hierarchical dependencies](../guides/hierarchical-dependencies.md#top)** — the
