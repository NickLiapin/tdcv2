...
> [`each`](../reference/attributes.md#top) to unroll it. A fixed `repeat` on a walked list
...
> walked list can say that. See [`order=` / `cycle=`](../generators/overview.md#top) for the
