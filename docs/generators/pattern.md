...
Both are reported by [`check`](../reference/cli.md#top) as well as by the run: `points`,
...
| :-------------------- | :----------- | :------------- |
| a PNG or SVG image     | bottom of the image | top of the image |
...
a flat line at 50 the *middle* of whatever range you ask for. Measured against the ink
