...
**English** · [Русский](../ru/generators/counters.md#top) · [Español](../es/generators/counters.md#top)

📖 **[Read this on the documentation site →](https://nickliapin.github.io/tdcv2/docs/generators/counters)**

← Previous: [Advanced Regex](./advanced-regex.md#top) · **[Contents](../README.md#top)** · Next: [Time series](./timeseries.md#top) →
...
Both live inside a [`<sequence>`](../core-concepts/sequences.md#top): the sequence is
computed once as an array, and each output row pulls the next value with
`${{Name}}` [interpolation](../core-concepts/output-formatting.md#top).
...
>
> A counter on a [child sequence](../guides/hierarchical-dependencies.md#top) numbers only the
...
[`step`](../reference/attributes.md#top) sets how far the counter moves between rows.
...
regardless of [`seed`](../core-concepts/determinism.md#top). Two runs with different
...
built-in [`${{_count}}`](../reference/builtins.md#top) — no sequence needed. It starts
...
[mask](../guides/masks-and-case.md#top), start somewhere other than 1, or advance by a
step other than 1.

## See also

- [Sequences](../core-concepts/sequences.md#top) — the container both counters live in.
- [Built-ins](../reference/builtins.md#top) — `_count`, `_first`, `_last`, `_total`.
- [Determinism](../core-concepts/determinism.md#top) — why the same seed reproduces the
