...
define. (For a whole **word** from a list, use [`text`](text.md#top) instead.)
...
> list, use [`text`](text.md#top): `<gen type="text" value="red,green,blue"/>`.
...
The alphabet registry is also available inside [`regex`](regex.md#top) and
[`advanced_regex`](advanced-regex.md#top) through the escape `\a{name}`, so you can
...
- [`alphabet`](../reference/attributes.md#top) and [`length`](../reference/attributes.md#top)
  in the attribute reference.
- **[Regex](regex.md#top)** — when the string has structure, not just a character set.
- **[Masks and case](../guides/masks-and-case.md#top)** — reshape a generated string
  after the fact.
