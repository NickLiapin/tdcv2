...
## A whole service, in four languages
...
[Two modes](#two-modes-it-generates-or-it-processes) — all four produce the same output.
...
>
> **[→ Writing a service generator](../guides/writing-a-service.md#top)** is the page that
> matters. It covers, with working code in all four languages:
>
