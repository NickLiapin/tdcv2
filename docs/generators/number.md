...
- [`length`](../reference/attributes.md#top) and [`first_zero`](../reference/attributes.md#top) in the attribute reference.
- **[Text](text.md#top)** — the same exact-`percent` machinery, for lists.
