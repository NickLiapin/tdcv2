...
| `local`               | Twenty-four: `ar`, `cs`, `de`, `el`, `en`, `es`, `fi`, `fr`, `hi`, `hu`, `id`, `it`, `ja`, `ko`, `nl`, `pl`, `pt`, `ru`, `sv`, `th`, `tr`, `uk`, `vi`, `zh-cn`. Nineteen also answer to a three-letter alias — `ara`, `ces`, `deu`, `ell`, `eng`, `spa`, `fin`, `fra`, `hun`, `ind`, `ita`, `jpn`, `kor`, `nld`, `pol`, `por`, `tur`, `ukr`, `vie` — and `hi`, `ru`, `sv`, `th`, `zh-cn` have none. Inherited from [`<env>`](../reference/tags.md#top) if omitted |
...
loaded by [`file`](./file.md#top), for instance. There only the text exists, so it
...
[`missing`](../guides/missing-data.md#top) blanked — gets no date either. There is
...
same rule [`running`](./running.md#top) and [`stat`](./stat.md#top) follow.
