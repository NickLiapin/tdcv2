...
**English** · [Русский](./ru/README.md#top) · [Español](./es/README.md#top)

📖 **[Read this on the documentation site →](https://nickliapin.github.io/tdcv2/docs/intro)**

---

- [Introduction](./intro.md#top)
...
- [Configuration structure](./core-concepts/configuration.md#top)
...
- [Overview](./generators/overview.md#top)
...
- [Advanced Regex](./generators/advanced-regex.md#top)
- [Increment & Decrement](./generators/counters.md#top)
- [Time series](./generators/timeseries.md#top)
- [Pattern](./generators/pattern.md#top)
- [HTTP service](./generators/http.md#top)
- [Running total](./generators/running.md#top)
- [Statistic](./generators/stat.md#top)
- [Formula](./generators/formula.md#top)

## Pools

- [Overview](./pools/overview.md#top)
- [Narrowing with filter](./pools/filter.md#top)
- [Linking pools together](./pools/linking.md#top)

## Constructs

- [Overview](./constructs/overview.md#top)
- [Choosing between values (mix)](./constructs/mix.md#top)
- [Lookup tables (switch)](./constructs/switch.md#top)
- [Conditional output (if)](./constructs/conditional-output.md#top)
...
- [Overview](./compute/overview.md#top)
- [Arithmetic](./compute/arithmetic.md#top)
- [Lists & iteration](./compute/lists.md#top)
- [Strings & formatting](./compute/strings.md#top)
- [Conditionals](./compute/conditionals.md#top)
- [A pack read line by line](./compute/walkthrough.md#top)

## Guides

- [Hierarchical dependencies](./guides/hierarchical-dependencies.md#top)
- [Coherent & relational data](./guides/coherent-data.md#top)
- [No repeats within a row](./guides/distinct.md#top)
- [Reading files & CSV](./guides/files-and-csv.md#top)
- [Output formats (CSV, JSON, SQL…)](./guides/output-formats.md#top)
- [Masks & case](./guides/masks-and-case.md#top)
- [Statistical distributions](./guides/statistical-distributions.md#top)
- [Anomalies & outliers](./guides/anomalies.md#top)
- [Missing data](./guides/missing-data.md#top)
...
- [Tags](./reference/tags.md#top)
- [Attributes](./reference/attributes.md#top)
- [Generators](./reference/generators.md#top)
...
- [The same names everywhere](./bindings/same-names.md#top)
