...
A [generator](../generators/overview.md#top) produces a value. A
[sequence](../core-concepts/sequences.md#top) is a column of those values. That covers most
...
`<pool>` lives **directly in [`<env>`](../core-concepts/configuration.md#top)**, beside
...
[points at another](linking.md#top) instead of nesting.
...
It is also [seekable](../core-concepts/determinism.md#top):
...
[`filter`](filter.md#top), which is what turns "three of the doctors are surgeons" into
...
[engine](../guides/large-outputs.md#top).

## Where to go next

- [Narrowing with `filter`](filter.md#top) — which members a row may draw from, and how
  that differs from `if`
- [Linking pools together](linking.md#top) — several pools, a pool that draws from a pool,
