...
**English** · [Русский](../ru/getting-started/editor-support.md#top) · [Español](../es/getting-started/editor-support.md#top)

📖 **[Read this on the documentation site →](https://nickliapin.github.io/tdcv2/docs/getting-started/editor-support)**

← Previous: [Your first dataset](./first-data.md#top) · **[Contents](../README.md#top)** · Next: [Configuration structure](../core-concepts/configuration.md#top) →
...
| :--------------------- | :------------------------------------------------------------------------------- |
| **Live errors**        | Red underlines as you type, at the exact position, with the same `TDC…` codes and "did you mean…" suggestions as [`check`](../reference/cli.md#top) |
...
| **Format**             | The same pretty-printer as [`tdcv2 format`](../reference/cli.md#top)                  |
...
[`tdcv2 pack add`](../data-packs/installing-packs.md#top) and restart the server to have its
...
- **[CLI reference](../reference/cli.md#top)** — `tdcv2 check` and `tdcv2 format`, the same
  two engines behind the underlines and the formatter.
- **[Error codes](../reference/errors.md#top)** — every code the editor can show you.
- **[Installing packs](../data-packs/installing-packs.md#top)** — what completion will offer.
