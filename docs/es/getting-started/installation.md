...
| C#       | `tdcv2 demo.tdc`, tras `dotnet tool install --global Tdcv2.Cli`                                                           |
| Java     | `java -jar tdcv2-0.1.6-cli.jar demo.tdc` — el clasificador `cli` de las coordenadas de la propia biblioteca               |
