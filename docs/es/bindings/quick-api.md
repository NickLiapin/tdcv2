...
[English](../../bindings/quick-api.md#top) · [Русский](../../ru/bindings/quick-api.md#top) · **Español**

📖 **[Abrir en el sitio de documentación →](https://nickliapin.github.io/tdcv2/es/docs/bindings/quick-api)**

← Anterior: [TypeScript](./typescript.md#top) · **[Contenido](../README.md#top)** · Siguiente: [Python](./python.md#top) →
...
- **[TypeScript](./typescript.md#top)** — la clase `TDC`, para conjuntos completos.
