...
> | Java        | descargar `tdcv2-0.3.2-cli.jar` de Maven Central   | `java -jar tdcv2-0.3.2-cli.jar pack add ru` |
>
...
>
> ```bash
> curl -LO https://repo1.maven.org/maven2/io/github/nickliapin/tdcv2/0.3.2/tdcv2-0.3.2-cli.jar
> java -jar tdcv2-0.3.2-cli.jar pack add ru
> ```
>
> Vale la pena un alias —`alias tdcv2='java -jar /ruta/a/tdcv2-0.3.2-cli.jar'`— y a partir de
