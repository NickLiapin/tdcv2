...
- **`dataPaths`** — las carpetas que el motor sí escanea en busca de paquetes. `pack add`
  ...
  motor a [paquetes que escribió usted mismo](writing-your-own.md#top).
...
catálogo encima. 108 conjuntos no caben en una pantalla, así que se recorren con la forma
que tienen:
...
El catálogo tiene hoy **108 conjuntos**: `common`, diez idiomas y 97 países. Un idioma o
