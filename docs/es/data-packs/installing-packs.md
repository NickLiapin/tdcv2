...
> | Java        | descargar `tdcv2-0.3.1-cli.jar` de Maven Central   | `java -jar tdcv2-0.3.1-cli.jar pack add ru` |
>
...
>
> ```bash
> curl -LO https://repo1.maven.org/maven2/io/github/nickliapin/tdcv2/0.3.1/tdcv2-0.3.1-cli.jar
> java -jar tdcv2-0.3.1-cli.jar pack add ru
> ```
>
> Vale la pena un alias —`alias tdcv2='java -jar /ruta/a/tdcv2-0.3.1-cli.jar'`— y a partir de
...
catálogo encima. 294 conjuntos no caben en una pantalla, así que se recorren con la forma
que tienen:
...
en ✓ installed English (language) (146 KB)
...
El catálogo tiene hoy **294 conjuntos**: `common`, 95 idiomas y 198 países. Un idioma o
