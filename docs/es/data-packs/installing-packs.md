...
> | Java        | descargar `tdcv2-0.2.1-cli.jar` de Maven Central   | `java -jar tdcv2-0.2.1-cli.jar pack add ru` |
>
...
> ```
>
> Vale la pena un alias —`alias tdcv2='java -jar /ruta/a/tdcv2-0.2.1-cli.jar'`— y a partir de
