...
| `seed`    | aleatorio   | Semilla del generador de números aleatorios — una corrida sin ella imprime la que eligió, en **stderr** |
...
> [!TIP]
> **Una corrida sin semilla igual le dice cómo repetirla**
>
> Omita `seed` y TDC elige una, y la escribe en **stderr** antes de los datos:
>
> ```
...
> ```
>
> Los datos van a stdout, así que `tdcv2 people.tdc > people.csv` deja la nota en pantalla y
> `2>/dev/null` tira el único registro de cómo volver a hacer ese archivo.
