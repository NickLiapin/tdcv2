...
```
INSERT INTO customers VALUES (1, 'Carlos', 'normal');
INSERT INTO orders VALUES (4, 1, 433);
INSERT INTO orders VALUES (5, 1, 474);
INSERT INTO customers VALUES (2, 'Delfín', 'normal');
INSERT INTO customers VALUES (3, 'Salvador', 'VIP');
INSERT INTO orders VALUES (11, 3, 2460);
INSERT INTO orders VALUES (12, 3, 5137);
INSERT INTO orders VALUES (13, 3, 7717);
INSERT INTO customers VALUES (4, 'Ulises', 'VIP');
...
> [!NOTE]
> **La forma corta, y cuándo es la correcta**
>
...
> más [`each`](../reference/attributes.md#top) para desplegarla. Un `repeat` fijo sobre una
...
> rechaza están en [`order=` / `cycle=`](../generators/overview.md#top).
