...
Una rama también puede calcular a partir de su propia fila: una
[`formula`](../generators/formula.md#en-una-rama) o un
[desplazamiento de fecha](../generators/date.md#en-una-rama) leen las columnas de esa fila y
nada más. Las construcciones que leen toda la corrida — [`running`](../generators/running.md#top),
[`stat`](../generators/stat.md#top), una fórmula con `prev()` — y una
[referencia a un pool](../pools/overview.md#top) tienen que ser secuencias propias (`TDC295`,
`TDC268`).
