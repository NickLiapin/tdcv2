...
| :------- | :------------ | :----------------------------------------------------------------------------------------------- |
| `that`   | uno de los dos | Una condición sobre valores de la ejecución entera, leída una vez, en el lenguaje de [`if=`](../reference/expressions.md#top) |
...
[valores internos](../reference/builtins.md#top). Nada nuevo que aprender, y ninguna columna
...
flujo. Véase [salidas grandes](../guides/large-outputs.md#top).
...
quedarse en un hilo. Véase [salidas grandes](../guides/large-outputs.md#top).
