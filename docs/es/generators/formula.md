...
- **Motor.** Un config con una fórmula corre en el
  [motor en memoria](../guides/large-outputs.md#top): el constructor de streaming todavía no
  sabe leer una columna hermana, el mismo límite que tiene un
  [desplazamiento de fecha](date.md#top). El enrutador se encarga; no hay nada que configurar.
