...
| :------------------------ | :---------------------------------------------- | :----------------: |
| `person.male.firstName`   | Un nombre de pila masculino                     |   10 + `zh-cn`     |
| `person.female.firstName` | Un nombre de pila femenino                      |   10 + `zh-cn`     |
| `person.lastName`         | Un apellido (masculinos + comunes del locale)   |   10 + `zh-cn`     |
| `person.male.diagnosis`   | Un diagnóstico masculino + los comunes          |        10          |
| `person.female.diagnosis` | Un diagnóstico femenino + los comunes           |        10          |
| `person.gender`           | Un género al azar; la etiqueta viene del locale |        10          |
| `person.b_day`            | Una fecha de nacimiento en el formato dado      |  solo el formato   |

Los diez son `ar`, `de`, `el`, `en`, `es`, `fr`, `it`, `pl`, `pt` y `ru` — los paquetes de
idioma que están llenos y no son esbozos. `zh-cn` trae nombres pero todavía no el resto.
...
| `geo.city`        | 93 de 111                     |
| `geo.region`      | 52                            |
| `geo.streetName`  | 36 (más 37 con `geo.streetNamed`) |
| `geo.postalCode`  | 24                            |
| `geo.province`    | 19                            |
| `geo.zip`         | 16                            |
| `geo.municipality`| 13                            |
