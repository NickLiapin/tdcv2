...
Las salidas de ejemplo de abajo son ilustrativas — los valores exactos dependen del seed
...
La misma fecha bajo cuatro formatos — mismo seed, así que la fecha es idéntica en cada
