...
>
> Cubre TDC **0.3.2**, última actualización **24 de septiembre de 2026** — la fecha del
...
- **[Un valor sin configuración](getting-started/quick-api.md#top).** `tdc.person.lastName()`:
...
- **Los valores sueltos son todo lo que va a necesitar.** TDC también los responde
  ...
  [el API de un valor](getting-started/quick-api.md#top)—, pero un faker dedicado trae un
...
| :---------------------------------------- | :------------ | :--------------------------- | :------ |
| **[TypeScript](bindings/typescript.md#top)** | npm           | `npm i tdcv2`                | 0.3.2   |
| **[Python](bindings/python.md#top)**         | PyPI          | `pip install tdcv2`          | 0.3.2   |
| **[Rust](bindings/rust.md#top)**             | crates.io     | `cargo add tdcv2`            | 0.3.2   |
| **[C#](bindings/csharp.md#top)**             | NuGet         | `dotnet add package Tdcv2`   | 0.3.2   |
| **[Java](bindings/java.md#top)**             | Maven Central | `io.github.nickliapin:tdcv2` | 0.3.2   |
