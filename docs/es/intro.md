...
>
> Cubre TDC **0.3.1**, última actualización **8 de septiembre de 2026** — la fecha del
...
| :---------------------------------------- | :------------ | :--------------------------- | :------ |
| **[TypeScript](bindings/typescript.md#top)** | npm           | `npm i tdcv2`                | 0.3.1   |
| **[Python](bindings/python.md#top)**         | PyPI          | `pip install tdcv2`          | 0.3.1   |
| **[Rust](bindings/rust.md#top)**             | crates.io     | `cargo add tdcv2`            | 0.3.1   |
| **[C#](bindings/csharp.md#top)**             | NuGet         | `dotnet add package Tdcv2`   | 0.3.1   |
| **[Java](bindings/java.md#top)**             | Maven Central | `io.github.nickliapin:tdcv2` | 0.3.1   |
