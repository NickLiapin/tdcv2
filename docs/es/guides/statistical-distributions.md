...
Un simple [`<gen type="number" value="150..200"/>`](../generators/number.md#top) sortea
...
`scale`— puede ser una [expresión](../reference/expressions.md#top) sobre las otras
...
ruido conforme avanza la corrida, y [`_count`](../reference/builtins.md#top) es el número
de fila:
...
> [!NOTE]
> **Por qué esto se permite y un `repeat=` por fila no**
>
...
> [motores de streaming](large-outputs.md#top). Un `repeat=` por fila
> ([varios valores](../constructs/multiple-values.md#top)) cambiaría el número de sorteos, y
...
![Un histograma plano junto a otro con forma de campana sobre el mismo rango](../../img/distributions/uniform-vs-normal.svg)

*El mismo rango 150–200, generado 20 000 veces de cada manera y contado.*

- **faint** — un rango simple: cada estatura es más o menos tan probable como cualquier otra
- **made** — el mismo rango con una distribución normal: una colina alrededor del centro
...
![Histogramas de las nueve distribuciones soportadas](../../img/distributions/nine-shapes.svg)

*Nueve corridas de 8000 valores cada una, contadas. Así se ven de verdad estos nombres.*

- **made** — 20 000 valores generados, contados en cubetas
...
![Una campana, y la misma campana recortada a unos límites](../../img/distributions/min-max.svg)
...
- **made** — a la izquierda: sin límites; a la derecha: la misma corrida limitada a 160 y 180
...
filas (vea [Salidas grandes](../guides/large-outputs.md#top)). Mil millones de
...
- **[Number](../generators/number.md#top)** — los modos de rango y de cadena de dígitos
  que este atributo reemplaza.
- **[Salidas grandes](../guides/large-outputs.md#top)** — por qué las distribuciones
  siguen siendo baratas con mil millones de filas.
- **[Datos coherentes](../guides/coherent-data.md#top)** — cómo mantener consistentes los
