...
| `uniq="true"` sobre un [contador](../generators/counters.md#top)                        | exacto en disco | acotada en ~1 GB  |
| `uniq="true"` sobre una secuencia compuesta (campos `<gen>` con nombre)              | exacto en disco | acotada en ~1 GB  |
| Un grupo [`<uniq>`](../constructs/unique-values.md#top) a nivel de env                  | exacto en disco | acotada en ~1 GB  |
