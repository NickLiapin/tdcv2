...
Eso es [`formula`](../generators/formula.md#top):
...
[Un parámetro puede seguir a otra columna](statistical-distributions.md#un-parámetro-puede-seguir-a-otra-columna).
