...
| `TDC247` | `step` en un `<gen type="date">` nombra una unidad que no puede recorrer   | Admitidas: second, minute, hour, day, week, month, year                                                                                                                                                     |
...
| `TDC249` | `days` nombra un día de la semana que no existe                            | mon, tue, wed, thu, fri, sat, sun — un rango `mon-fri` o una lista `sun,wed`                                                                                                                                 |
| `TDC250` | `days` con un `step` de una semana o más                                   | Ese paso ya fija el día de la semana, así que el filtro coincidiría con todas las filas o con ninguna                                                                                                        |
