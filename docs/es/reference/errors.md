...
| `TDC250` | `weekdays` con un paso de un número entero de semanas, o un paso de calendario | Ese paso ya fija el día de la semana, así que el filtro coincidiría con todas las filas o con ninguna                                                                                                        |
