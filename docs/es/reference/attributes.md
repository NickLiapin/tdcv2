...
| `of`        | En `<gen type="running">`: la columna que se acumula. En `<gen type="stat">`: la columna a resumir                                                                                   | [Total acumulado](../generators/running.md#top), [Estadística](../generators/stat.md#top) |
