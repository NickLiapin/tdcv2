...
| `each`                 | Repetir una línea por cada elemento de la lista; en `<assert>`, una condición que toda fila debe cumplir | [Tablas relacionales](../constructs/relational-tables.md#top), [Configuraciones que se comprueban solas](../constructs/self-checking.md#top) |
