...
ponerlo, y el comando lo dice en vez de aceptar la bandera y descartarla. Los recuentos
vienen del proceso que renderiza, de modo que una ejecución repartida entre workers informa
las fases y el `done` final en lugar de un recuento de filas.
