...
[`<gen>`](../generators/overview.md#top)'s job; `<compute>` **processes values you already
have**. It lives right in the config, inside a
[`<sequence>`](../core-concepts/sequences.md#top), and it's how real-world checksums get
built: a credit card's Luhn digit, an ISBN check digit, an IBAN mod-97.

- [`<gen>`](../generators/overview.md#top) **produces** a value (random, from a
  range/list/template).
...
>
> That is why **`uniq="true"` is not allowed on such a sequence** ([`TDC218`](../reference/errors.md#top)).
...
> `<gen>` is [`TDC219`](../reference/errors.md#top). Put the `<compute>` in its own
...
final digit, and [`<concat>`](strings.md#top) glues it onto the base.
...
the [Compute functions reference](../reference/compute.md#top).
...
### [Strings & formatting](strings.md#top)
...
[`<gen>` attributes and `${{X|…}}` filters](../guides/masks-and-case.md#top).

### [Conditionals](conditionals.md#top)
...
[`<gen>`](../generators/overview.md#top). Two mechanisms exist to help pack authors.
...
- **[Compute functions reference](../reference/compute.md#top)** — the full catalog.
- **[Conditionals](conditionals.md#top)** — `<choose>`, predicates, and `<valid>` in depth.
- **[Masks & case](../guides/masks-and-case.md#top)** — the same formatting via filters and
  `<gen>` attributes.
