...
← Previous: [Comparison and truth](../reference/comparison.md#top) · **[Contents](../README.md#top)** · Next: [Python](./python.md#top) →
...
| `mode`          | `"memory"` or `"disk"` — the same choice as [`--mode`](../reference/cli.md#top)         |
...
| `toColumns()`      | columns; numbers as `Float64Array`    | numeric pipelines, many runs   |
