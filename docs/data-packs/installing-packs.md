...
> | Java          | download `tdcv2-0.1.7-cli.jar` from Maven Central      | `java -jar tdcv2-0.1.7-cli.jar pack add ru` |
>
...
> ```
>
> Worth an alias — `alias tdcv2='java -jar /path/to/tdcv2-0.1.7-cli.jar'` — after which every
