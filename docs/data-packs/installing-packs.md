...
> | Java          | download `tdcv2-0.2.0-cli.jar` from Maven Central      | `java -jar tdcv2-0.2.0-cli.jar pack add ru` |
>
...
> ```
>
> Worth an alias — `alias tdcv2='java -jar /path/to/tdcv2-0.2.0-cli.jar'` — after which every
...
catalogue at you. 109 bundles do not fit on a screen, so they are browsed the way they
are shaped:
...
The catalogue holds **109 sets today**: `common`, 10 languages, and 98 countries. A
