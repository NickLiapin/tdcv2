...
← Previous: [Overview](./overview.md#top) · **[Contents](../README.md#top)** · Next: [Catalogue](./catalogue.md#top) →
...
> | Java          | download `tdcv2-0.3.1-cli.jar` from Maven Central      | `java -jar tdcv2-0.3.1-cli.jar pack add ru` |
>
...
> ```
>
> Worth an alias — `alias tdcv2='java -jar /path/to/tdcv2-0.3.1-cli.jar'` — after which every
