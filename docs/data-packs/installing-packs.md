...
> | Java          | download `tdcv2-0.3.2-cli.jar` from Maven Central      | `java -jar tdcv2-0.3.2-cli.jar pack add ru` |
>
...
> ```
>
> Worth an alias — `alias tdcv2='java -jar /path/to/tdcv2-0.3.2-cli.jar'` — after which every
