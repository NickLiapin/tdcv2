...
**English** · [Русский](../ru/data-packs/catalogue.md#top) · [Español](../es/data-packs/catalogue.md#top)

📖 **[Read this on the documentation site →](https://nickliapin.github.io/tdcv2/docs/data-packs/catalogue)**

← Previous: [Installing packs](./installing-packs.md#top) · **[Contents](../README.md#top)** · Next: [Writing your own](./writing-your-own.md#top) →
...
| Pack | Name | Holds |
| :--- | :--- | :--- |
| `albania` | Albania **(next release)** | docs, education, finance, geo, government, holiday, phone, sport, tax, telecom, vehicle |
...
| `armenia` | Armenia **(next release)** | docs, education, finance, geo, government, holiday, language, phone, phoneLandline, product, sport, tax, telecom, vehicle |
...
| `azerbaijan` | Azerbaijan **(next release)** | docs, education, finance, geo, government, holiday, phone, phoneLandline, phoneMobilePrefix, phoneNational, sport, tax, vehicle |
| `bahrain` | Bahrain | docs, education, finance, geo, holiday, phone, sport, vehicle |
| `bangladesh` | Bangladesh **(next release)** | docs, education, finance, geo, holiday, phone, sport, tax, vehicle |
...
| `bhutan` | Bhutan **(next release)** | docs, education, finance, geo, government, holiday, phone, phoneAreaCode, phoneLandline, phoneMobilePrefix, phoneNational, society, sport, tax, telecom, vehicle |
| `bolivia` | Bolivia | docs, education, finance, geo, holiday, phone, sport, tax, vehicle |
| `bosnia_and_herzegovina` | Bosnia And Herzegovina **(next release)** | docs, education, finance, geo, government, holiday, language, phone, phoneLandline, sport, tax, vehicle |
...
| `cambodia` | Cambodia **(next release)** | docs, education, finance, geo, government, holiday, legal, phone, phoneAreaCode, phoneLandline, phoneMobilePrefix, phoneMobilePrefixWithLength, sport, tax, vehicle |
...
| `georgia` | Georgia **(next release)** | docs, education, finance, geo, government, holiday, legal, phone, phoneAreaCode, phoneLandline, phoneMobilePrefix, sport, tax, vehicle |
| `germany` | Germany | docs, education, finance, geo, holiday, phone, sport, tax, vehicle |
| `ghana` | Ghana **(next release)** | docs, education, finance, geo, holiday, language, phone, phoneNational, phonePrefix, sport, tax, vehicle |
...
| `iceland` | Iceland **(next release)** | docs, education, finance, geo, government, holiday, phone, phoneLandline, sport, tax, telecom, vehicle |
| `india` | India **(next release)** | docs, education, finance, geo, holiday, language, phone, sport, tax, vehicle |
| `indonesia` | Indonesia **(next release)** | docs, education, finance, geo, holiday, phone, sport, tax, vehicle |
| `iran` | Iran **(next release)** | docs, education, finance, geo, holiday, phone, phoneLandline, sport, tax, vehicle |
...
| `israel` | Israel **(next release)** | docs, education, finance, geo, holiday, phone, phoneLandline, sport, tax, vehicle |
...
| `japan` | Japan **(next release)** | docs, education, finance, geo, holiday, phone, phoneLandline, sport, tax, vehicle |
...
| `kenya` | Kenya **(next release)** | docs, education, finance, geo, holiday, phone, phoneLandline, sport, tax, vehicle |
...
| `laos` | Laos **(next release)** | docs, education, finance, geo, government, holiday, legal, phone, phoneAreaCode, phoneLandline, phoneMobilePrefix, sport, tax, vehicle |
...
| `malaysia` | Malaysia **(next release)** | docs, education, finance, geo, government, holiday, phone, sport, tax, vehicle |
| `maldives` | Maldives **(next release)** | calendar, docs, education, finance, geo, government, holiday, holidayDate, holidayEnglish, phone, phoneLandline, phoneMobilePrefix, phoneNational, sport, tax, vehicle |
...
| `moldova` | Moldova **(next release)** | docs, education, finance, food, geo, holiday, language, phone, sport, tax, vehicle |
| `monaco` | Monaco | education, finance, geo, holiday, phone, sport, vehicle |
| `mongolia` | Mongolia **(next release)** | docs, education, finance, geo, government, holiday, legal, phone, phoneAreaCode, phoneLandline, phoneMobilePrefix, sport, tax, telecom, vehicle |
...
| `myanmar` | Myanmar **(next release)** | docs, education, finance, geo, government, holiday, legal, phone, phoneLandline, phoneMobilePrefix, sport, tax, vehicle |
| `nepal` | Nepal **(next release)** | calendar, docs, education, finance, geo, holiday, phone, phoneAreaCode, phoneLandline, sport, symbol, symbolEnglish, tax, vehicle |
...
| `nigeria` | Nigeria **(next release)** | docs, education, finance, geo, holiday, language, phone, phoneNational, phonePrefix, sport, tax, vehicle |
| `north_macedonia` | North Macedonia **(next release)** | docs, education, finance, geo, government, holiday, language, phone, phoneAreaCode, sport, tax, vehicle |
| `norway` | Norway **(next release)** | docs, education, finance, geo, government, holiday, phone, phoneLandline, phoneMobilePrefix, phoneNational, sport, tax, vehicle |
| `oman` | Oman | docs, education, finance, geo, holiday, phone, sport, vehicle |
| `pakistan` | Pakistan **(next release)** | docs, education, finance, geo, holiday, language, phone, sport, tax, vehicle |
...
| `philippines` | Philippines **(next release)** | docs, education, finance, geo, holiday, person, phone, sport, tax, vehicle |
...
| `serbia` | Serbia **(next release)** | docs, education, finance, geo, holiday, phone, sport, tax, vehicle |
| `singapore` | Singapore **(next release)** | docs, education, finance, geo, holiday, phone, phoneLandline, sport, tax, vehicle |
...
| `south_korea` | South Korea **(next release)** | docs, education, finance, geo, holiday, phone, phoneAreaCode, phoneLandline, sport, tax, vehicle |
...
| `sri_lanka` | Sri Lanka **(next release)** | docs, education, finance, geo, holiday, language, phone, phoneLandline, sport, tax, vehicle |
...
| `taiwan` | Taiwan **(next release)** | calendar, docs, education, finance, geo, government, holiday, legal, phone, phoneAreaCode, phoneLandline, phoneMobilePrefix, sport, tax, telecom, vehicle |
| `tajikistan` | Tajikistan | docs, education, finance, geo, holiday, phone, sport, vehicle |
| `tanzania` | Tanzania **(next release)** | docs, education, finance, geo, holiday, holidayEnglish, phone, phoneLandline, sport, tax, vehicle |
| `thailand` | Thailand **(next release)** | calendar, docs, education, finance, geo, holiday, phone, phoneLandline, sport, tax, vehicle |
...
| `turkey` | Turkey **(next release)** | docs, education, finance, geo, holiday, phone, sport, tax, vehicle |
| `turkmenistan` | Turkmenistan **(next release)** | docs, education, finance, geo, government, holiday, phone, phoneAreaCode, phoneLandline, phoneMobilePrefix, phoneNational, sport, tax, vehicle |
| `uae` | Uae | docs, education, finance, geo, holiday, phone, sport, vehicle |
| `uganda` | Uganda **(next release)** | culture, docs, education, finance, geo, holiday, phone, phoneLandline, sport, tax, vehicle |
| `ukraine` | Ukraine **(next release)** | docs, education, finance, geo, holiday, phone, sport, tax, vehicle |
...
| `uzbekistan` | Uzbekistan **(next release)** | docs, education, finance, geo, government, holiday, phone, phoneAreaCode, phoneAreaCodeWithRegion, phoneLandline, phoneMobilePrefix, phoneNational, sport, tax, telecom, vehicle |
...
| `vietnam` | Vietnam **(next release)** | docs, education, finance, geo, holiday, phone, sport, tax, vehicle |
| `yemen` | Yemen | docs, education, finance, geo, holiday, phone, sport |
| `zimbabwe` | Zimbabwe **(next release)** | docs, education, finance, geo, holiday, language, phone, sport, tax, vehicle |

Install any of them with `tdcv2 pack add <pack>`.

> This pack is newer than the published packages. It downloads, but its addresses will not resolve until the next release — and while it sits in your pack store, unrelated configs emit TDC171 warnings. Verified against the published 0.2.2.
