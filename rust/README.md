...
87 languages and 198 country packs, each with the right check-digit
...
compiled into the binary. Most packs are downloaded at runtime — 87 languages,
198 countries — so `tdc.lang().ru()` would not exist for the pack a user
