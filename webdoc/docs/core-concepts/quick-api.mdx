...
:::tip[An address that isn't installed says so]
...
See [Installing packs](../data-packs/installing-packs.mdx).
:::
...
- **[TypeScript](../bindings/typescript.mdx)** — the `TDC` class, for whole datasets.
- **[Data packs](../data-packs/overview.mdx)** — what a pack is and how addresses are organised.
