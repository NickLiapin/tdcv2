...
| An env-level [`<uniq>`](../constructs/unique-values.mdx) group           | exact on-disk | **bounded** while repeats stay in hand |
...
[`TDC299`](../reference/errors.mdx) warns about them from 100,000 rows up. A `uniq` counter
