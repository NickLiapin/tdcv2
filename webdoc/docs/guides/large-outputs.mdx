...
| [`weight=`](../generators/file.mdx) and [`row=`](../generators/file.mdx) on the same `file` generator                                                                | Weighting a linked row draw to an exact quota needs the file's totals up front.                                                                |
...
[`text`](../generators/text.mdx) lists.
