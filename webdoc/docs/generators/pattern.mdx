...
<Terminal title="./run saw.tdc (200 teeth into 5 rows)">
...
<Figure
  ...
  caption="The same zigzag. With rows to spare, the teeth come through; with six rows, each one reports the mean of everything it covers instead of whichever tooth sat under it."
/>

<Legend
  items={[["drawn", "the drawn zigzag"], ["made", "generated values"], ["A", "300 rows — the teeth come through"], ["B", "6 rows — each reports the mean of the slice it covers"]]}
/>
