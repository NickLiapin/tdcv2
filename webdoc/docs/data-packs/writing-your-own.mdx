...
:::note[What's allowed inside a generator (today)]
Primitives — [`regex`](../generators/regex.mdx), [`number`](../generators/number.mdx),
[`symbol`](../generators/symbol.mdx), [`date`](../generators/date.mdx),
[`text`](../generators/text.mdx) — the
[`<mix>`](../reference/tags.mdx#distributions-and-choice) / `percent` distribution, and
