...
| Java          | download `tdcv2-%%TDC_JAVA_VERSION%%-cli.jar` from Maven Central      | `java -jar tdcv2-%%TDC_JAVA_VERSION%%-cli.jar pack add ru` |
...
Worth an alias — `alias tdcv2='java -jar /path/to/tdcv2-%%TDC_JAVA_VERSION%%-cli.jar'` — after which every
