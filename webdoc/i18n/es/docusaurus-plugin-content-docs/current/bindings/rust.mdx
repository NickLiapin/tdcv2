...
:::tip[En crates.io — versión %%TDC_VERSION%%]
...
vez](../getting-started/quick-api.mdx).
...
cinco paquetes, escritos según la costumbre de cada lenguaje. [La tabla está aquí](same-names.mdx),
