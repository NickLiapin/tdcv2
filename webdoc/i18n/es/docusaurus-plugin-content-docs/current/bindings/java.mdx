...
Los nombres de los métodos son un espejo de la [API de TypeScript](typescript.mdx): la
tabla está en [los mismos nombres en todas partes](same-names.mdx), y los conjuntos de
