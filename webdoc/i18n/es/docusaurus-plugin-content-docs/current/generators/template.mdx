...
el [catálogo](../data-packs/catalogue.mdx).
Cualquier otro locale recibe [TDC217](../reference/errors.mdx), que nombra los locales que
...
Lea [Paquetes de datos](../data-packs/overview.mdx) para saber qué trae un país concreto.
...
:::note[La misma fecha de nacimiento, dos valores por omisión]
`person.b_day` y [`<gen type="date" value="birth">`](date.mdx#un-cumpleaños-con-valuebirth)
...
rechaza con [TDC073](../reference/errors.mdx) en vez de leerse mal en silencio.
...
<Terminal title="./run event.tdc (precision=second)">
{`2024-08-10 07:59:57
2021-01-22 23:48:52
2021-06-06 17:44:00
2025-12-17 04:31:37`}
