...
Añada un [`repeat`](../constructs/multiple-values.mdx) fijo y la fila tomará **N valores**
...
<Terminal title="./run steps.tdc (3 filas)">
...
escribe el [ciclo de vida completo](../constructs/relational-tables.mdx) de un registro en
...
la [cuota de longitudes](../constructs/multiple-values.mdx) no tiene ese número. **Una
