...
| :----------------------------------------- | :---------- | :------------------------------------------------------------------------------ |
| [`src`](../reference/attributes.mdx)       | sí          | Dónde está el archivo — ruta relativa, `@data`, `pkg:` o absoluta               |
...
en el orden en que aparecen en el archivo (vea [Máscaras y mayúsculas](../guides/masks-and-case.mdx)).
