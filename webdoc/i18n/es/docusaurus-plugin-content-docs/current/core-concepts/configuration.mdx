...
:::tip[Una corrida sin semilla igual le dice cómo repetirla]
...
([`TDC021`](../reference/errors.mdx)): allí cumplen dos, el motor leería el de la derecha y el
...
registro están en
[Salida y formato](output-formatting.mdx#fixtures--texto-alrededor-de-los-registros).
