...
<Legend items={[["A", "primera ejecución, un seed"], ["B", "segunda ejecución, el mismo seed — idéntica valor por valor"], ["C", "un seed distinto: datos de la misma forma, pero ningún número en común"]]} />
