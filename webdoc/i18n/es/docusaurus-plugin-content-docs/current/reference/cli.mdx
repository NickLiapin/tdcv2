...
:::note[De dónde sale `tdcv2` antes del primer lanzamiento]
...
y [Instalación](../getting-started/installation.mdx) tiene la pestaña de cada uno. Java es
...
y los datos — vea [Instalar packs](../data-packs/installing-packs.mdx) — y `tdcv2 format`
([abajo](#tdcv2-format)).
