...
| Java     | `java -jar tdcv2-%%TDC_JAVA_VERSION%%-cli.jar tdcv2-examples/01-starter.tdc` — el clasificador `cli` de las coordenadas de la propia biblioteca               |
...
:::note[Los valores de aquí vienen de una semilla]
