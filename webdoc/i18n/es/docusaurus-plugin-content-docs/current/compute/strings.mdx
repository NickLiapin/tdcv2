...
[`<gen>`](../generators/overview.mdx). `<gen slice="1,3">` se rechaza con TDC015. La guía
...
:::caution[Una palabra termina en un espacio, y en ningún otro sitio]
...
`x[-1]` contando desde el final — y la [guía de máscaras](../guides/masks-and-case.mdx#mover-piezas--x0-w0-y-rangos)
