---
title: Un pack leído línea por línea
sidebar_position: 6
---
...
si ha leído [Listas](lists.mdx) y [Aritmética](arithmetic.mdx), ya conoce todas las
etiquetas de abajo.
...
<Figure
  ...
  frame
  zoom
  caption="El config como grafo: dos columnas sorteadas alimentan una calculada, y cada flecha dice quién usa a quién."
/>
...
<Figure
  ...
  frame
  zoom
  caption="El mismo compute como árbol, en el canvas de Studio. Es más ancho que esta columna — haga clic para abrirlo a tamaño completo y recorrerlo."
/>
...
- **[Resumen](overview.mdx)** — la tubería, las ranuras y las etiquetas cuyo nombre engaña.
- **[Listas e iteración](lists.mdx)** — de dónde sale una lista y `<reduce>` paso a paso.
- **[Aritmética](arithmetic.mdx)** — división entera, `<mod>` y la frontera cadena-número.
- **[Escribir los suyos](../data-packs/writing-your-own.mdx)** — cómo publicar un generador como este.
