...
| [`file` con `read="quantile"`](../generators/file.mdx) | **texto** — declare `type="float"` si quiere una columna numérica |
...
Una [lectura por cuantiles](../generators/file.mdx) es la única fila de esa tabla donde
