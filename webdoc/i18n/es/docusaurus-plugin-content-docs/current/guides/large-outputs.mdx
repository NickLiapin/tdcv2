...
acumulado](../generators/running.mdx#qué-motor-lo-ejecuta), un
[estadístico](../generators/stat.mdx), una [fecha medida desde otra
columna](../generators/date.mdx), un `parent="Nombre"` pelado sin valor, una referencia a
un [pool](../pools/overview.mdx) — una corrida a disco ruteada automáticamente cae de
