...
| `uniq="true"` sobre un [contador](../generators/counters.mdx)                        | exacto en disco | acotada           |
| `uniq="true"` sobre una secuencia compuesta (campos `<gen>` con nombre)              | exacto en disco | acotada           |
| Un grupo [`<uniq>`](../constructs/unique-values.mdx) a nivel de env                  | exacto en disco | acotada           |
