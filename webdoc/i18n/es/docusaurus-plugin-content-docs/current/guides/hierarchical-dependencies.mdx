...
:::note[Se compara el valor que el padre SACÓ]

`parent="Parent.Value"` se resuelve antes de que corra la
[capa de formato](../guides/masks-and-case.mdx), así que compara contra el valor que
...
:::caution[`missing=` en el padre no detiene al hijo]
...
[`missing=`](../guides/anomalies.mdx) sigue contando esas filas como suyas, y el hijo
las llena:
