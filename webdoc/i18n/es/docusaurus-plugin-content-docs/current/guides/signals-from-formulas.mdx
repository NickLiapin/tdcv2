---
title: Señales a partir de fórmulas
sidebar_position: 14
---
...
trabajo de [`<gen type="formula">`](../generators/formula.mdx), y es la única construcción
...
`exp` y `pow` son [funciones de expresión](../reference/expressions.mdx) corrientes, y se
...
<Figure
  ...
  alt="Cinco campanas tenues y la línea más oscura de su suma a lo largo de un latido"
  caption="Un latido, desarmado. Todos los valores salen de ejecutar la configuración de abajo."
/>
...
<Figure
  ...
  alt="Cinco segundos de trazo sobre papel cuadriculado, con verticales punteadas en los segundos exactos"
  caption="Cinco segundos. Los picos se alejan de las marcas de segundo y vuelven."
/>
...
:::note[Viva y aun así reproducible]
...
[`running`](../generators/running.mdx). Si necesita una sola cifra calculada sobre toda la
ejecución, vea [`stat`](../generators/stat.mdx).
