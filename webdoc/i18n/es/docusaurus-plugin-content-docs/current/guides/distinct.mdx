...
la verificación de viabilidad que [`uniq`](../constructs/unique-values.mdx) hace antes de generar.
...
valor** — un [`<gen>`](../generators/overview.mdx) simple o un `<switch>`. Una secuencia
...
el dataset. Para la regla vertical, vea [Valores únicos](../constructs/unique-values.mdx).
