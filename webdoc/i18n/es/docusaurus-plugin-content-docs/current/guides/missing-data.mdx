...
:::note[El marcador se formatea como cualquier otro valor]
...
[lenguaje de expresiones](../reference/expressions.mdx) que `if=`, y decide qué
...
`_value` es el valor **después** de [`anomaly=`](anomalies.mdx), porque ese es el
