...
| :---------------------------------------- | :------------ | :--------------------------- | :------ |
| **[TypeScript](bindings/typescript.mdx)** | npm           | `npm i tdcv2`                | 0.1.6   |
| **[Python](bindings/python.mdx)**         | PyPI          | `pip install tdcv2`          | 0.1.6   |
| **[Rust](bindings/rust.mdx)**             | crates.io     | `cargo add tdcv2`            | 0.1.6   |
| **[C#](bindings/csharp.mdx)**             | NuGet         | `dotnet add package Tdcv2`   | 0.1.6   |
| **[Java](bindings/java.mdx)**             | Maven Central | `io.github.nickliapin:tdcv2` | 0.1.6   |
