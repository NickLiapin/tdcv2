...
| :--- | :--- | :--- | :--- |
| **[TypeScript](bindings/typescript.mdx)** | npm | `npm i tdcv2` | 0.1.3 |
| **[Python](bindings/python.mdx)** | PyPI | `pip install tdcv2` | 0.1.3 |
| **[Rust](bindings/rust.mdx)** | crates.io | `cargo add tdcv2` | 0.1.3 |
| **[C#](bindings/csharp.mdx)** | NuGet | `dotnet add package Tdcv2` | 0.1.3 |
| **[Java](bindings/java.mdx)** | Maven Central | todavía no — compilar desde el repositorio | — |
