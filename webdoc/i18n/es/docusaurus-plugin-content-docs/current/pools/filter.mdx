...
[rechaza](../reference/errors.mdx), porque una referencia publica un REGISTRO entero y no
...
[`TDC225`](../reference/errors.mdx). La línea la marca lo que se puede probar, no cuándo
