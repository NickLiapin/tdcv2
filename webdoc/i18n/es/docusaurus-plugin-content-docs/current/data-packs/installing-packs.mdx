...
| Java        | descargar `tdcv2-%%TDC_JAVA_VERSION%%-cli.jar` de Maven Central   | `java -jar tdcv2-%%TDC_JAVA_VERSION%%-cli.jar pack add ru` |
...
java -jar tdcv2-%%TDC_JAVA_VERSION%%-cli.jar pack add ru
```

Vale la pena un alias —`alias tdcv2='java -jar /ruta/a/tdcv2-%%TDC_JAVA_VERSION%%-cli.jar'`— y a partir de
