...
:::note[Qué se permite dentro de un generador (hoy)]
Las primitivas —[`regex`](../generators/regex.mdx),
[`number`](../generators/number.mdx), [`symbol`](../generators/symbol.mdx),
[`date`](../generators/date.mdx), [`text`](../generators/text.mdx)—, la distribución
[`<mix>`](../reference/tags.mdx#distribuciones-y-selección) / `percent`, y las
