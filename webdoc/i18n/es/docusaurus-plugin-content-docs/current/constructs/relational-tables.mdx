...
Lo hacen dos piezas. [`order="sequential"`](../reference/attributes.mdx) hace que la lista
de `repeat` recorra los valores en el orden en que están escritos en vez de sortearlos, y
[`parent`](../guides/hierarchical-dependencies.mdx) elige qué camino toma este registro:
