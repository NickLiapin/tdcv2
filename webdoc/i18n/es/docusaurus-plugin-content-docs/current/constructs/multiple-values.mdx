...
la [semilla](../core-concepts/determinism.mdx) decide a cuál, así que 201 filas salen
...
<Terminal title="./run orders.tdc (8 filas)">
{`[896;648;701;334]
[]
[765]
[342;706]
...
<Terminal title="./run orders.tdc (20 000 filas, contadas)">
...
:::note[Exacto, a diferencia de una distribución dibujada]
`lengths=` es una **cuota**: 40% significa 40.00%. Una forma dibujada con
[`<gen type="pattern" mode="density">`](../generators/pattern.mdx) reproduce una *forma* con
...
Un [pack de datos](../data-packs/overview.mdx) ponderado sigue funcionando y sigue
...
([`TDC291`](../reference/errors.mdx)) en vez de cumplir uno en silencio y descartar el otro.
Si quiere proporciones sobre las **longitudes** de las listas, póngalas en un
[`<mix>`](./mix.mdx) o un `<switch>` por fuera, con `repeat` en el
generador de dentro.
