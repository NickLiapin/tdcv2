...
| Java    | `java -jar tdcv2-%%TDC_JAVA_VERSION%%-cli.jar tdcv2-examples/01-starter.tdc` — классификатор `cli` у координат самой библиотеки                     |
...
пакета в каждом языке — на следующей странице — [Quick API](quick-api.mdx).
