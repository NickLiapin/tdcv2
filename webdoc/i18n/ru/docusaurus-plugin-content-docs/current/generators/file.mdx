...
| :----------------------------------------- | :----------- | :------------------------------------------------------------------------ |
| [`src`](../reference/attributes.mdx)       | да           | Где файл — относительный путь, `@data`, `pkg:` или абсолютный путь        |
...
в том порядке, в каком они идут в файле (см. [Маски и регистр](../guides/masks-and-case.mdx)).
