...
:::note[Это ящик с россыпью значений]
...
конфиг, см. [Первый датасет](../getting-started/first-data.mdx). Берите этот API, когда
...
пакетов](../data-packs/installing-packs.mdx).
...
Все генераторы и их атрибуты — в [справочнике генераторов](../generators/number.mdx).
...
[первого датасета](../getting-started/first-data.mdx).

## См. также

- **[TypeScript](../bindings/typescript.mdx)**, **[Python](../bindings/python.mdx)**, **[Java](../bindings/java.mdx)**, **[C#](../bindings/csharp.mdx)**, **[Rust](../bindings/rust.mdx)** — те же пять пакетов, для целых наборов данных.
- **[Пакеты данных](../data-packs/overview.mdx)** — что такое пакет и как устроены адреса.
- **[Установка пакетов](../data-packs/installing-packs.mdx)** — как добавить остальные 120.
