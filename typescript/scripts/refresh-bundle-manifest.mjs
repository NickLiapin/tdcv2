...
const GEOGRAPHY = {
  ...
  andorra: { regions: ['europe'], point: [1.6, 42.5] },
  angola: { regions: ['africa'], point: [17, -12] },
  antigua_and_barbuda: { regions: ['north'], point: [-61.8, 17.1] },
  ...
  botswana: { regions: ['africa'], point: [24, -22] },
  brazil: { regions: ['south'], point: [-52, -10] },
  brunei: { regions: ['asia'], point: [114.7, 4.5] },
  ...
  central_african_republic: { regions: ['africa'], point: [21, 6.6] },
  ...
  dominica: { regions: ['north'], point: [-61.4, 15.4] },
  ...
  jamaica: { regions: ['north'], point: [-77.3, 18.1] },
  ...
  kiribati: { regions: ['oceania'], point: [173, 1.4] },
  ...
  lesotho: { regions: ['africa'], point: [28.2, -29.6] },
  liberia: { regions: ['africa'], point: [-9.4, 6.4] },
  ...
  palau: { regions: ['oceania'], point: [134.6, 7.5] },
  ...
  saint_kitts_and_nevis: { regions: ['north'], point: [-62.7, 17.3] },
  saint_lucia: { regions: ['north'], point: [-61, 13.9] },
  saint_vincent_and_the_grenadines: { regions: ['north'], point: [-61.2, 13.2] },
  samoa: { regions: ['oceania'], point: [-172.1, -13.6] },
  ...
  seychelles: { regions: ['africa'], point: [55.5, -4.6] },
  ...
  solomon_islands: { regions: ['oceania'], point: [160, -9.6] },
  ...
  suriname: { regions: ['south'], point: [-56, 4] },
  ...
  tonga: { regions: ['oceania'], point: [-175.2, -21.2] },
  trinidad_and_tobago: { regions: ['north', 'south'], point: [-61.2, 10.7] },
  tunisia: { regions: ['africa'], point: [9.5, 34] },
  turkey: { regions: ['europe', 'asia'], point: [35.2, 39] },
  turkmenistan: { regions: ['asia'], point: [59.6, 39] },
  tuvalu: { regions: ['oceania'], point: [179.2, -8.5] },
  ...
  vanuatu: { regions: ['oceania'], point: [167, -16] },
